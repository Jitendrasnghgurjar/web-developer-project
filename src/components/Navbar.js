...
import './Navbar.css'
import logo from '../Assests/logom.png'
...
return (
    <nav className = "navbar">
        ...
        <div className = "nav-links">
            ...
            <Link activeClass='active' to = 'project' spy = {true} smooth = {true} offset={-50} duration={500} className='nav-links-item'>Project</Link>
            <Link activeClass='active' to = 'social' spy = {true} smooth = {true} offset={-50} duration={500} className='nav-links-item'>Social</Link>
